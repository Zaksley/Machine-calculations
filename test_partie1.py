...
def test_add():
    ...
    printResult("add(123.45,0.006789,4)",source.prec_add(123.45,0.006789,4)==123.4,6,total) #failure
...
def test_prod():
    ...
    total = 6
    printResult("prod(1/3,3,6)",source.prec_prod(1/3,3,6)==1,1,total) #failure
    ...
    #printResult("prod(-0.2,0.999,4)",souce.prec_prod(-0.2,0.999,4)==-0.1998,6,total) #error
    print("\n")

def test_log():
    print(np.log(2))
    print(source.calcul_log(100000))
