...
\begin{figure}[ht]
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.48]{erreur_add.png}
        \caption{Erreur relative sur la somme}
        \label{fig:erreur_sur_la_somme_2}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.48]{erreur_prod.png}
...
\begin{figure}[!htb]
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.35]{ecart_atan.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.35]{ecart_arctan_base10.png}
